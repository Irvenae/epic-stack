...
```sh
npx create-remix@latest . --template irvenae/epic-stack
```
...
```sh
SKIP_SETUP=true SKIP_FORMAT=true SKIP_DEPLOYMENT=true npx create-remix@latest . --template irvenae/epic-stack
```

Or, on windows:

```
set SKIP_SETUP=true && set SKIP_FORMAT=true && set SKIP_DEPLOYMENT=true && npx create-remix@latest . --template irvenae/epic-stack
```
